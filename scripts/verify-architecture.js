...
{
  const { applySafeNameReplacer } = require('../lib/nameReplacer');
...
{
  const { validateNewEntity } = require('../lib/glossaryService');
...
async function testInFlightLock() {
  const { inFlightLock } = require('../lib/inFlightLock');
...
async function runAll() {
  ...
  console.log('================================================================');
  console.log('🎉 ALL ARCHITECTURE UNIT & RECOVERY TESTS COMPLETED SUCCESSFULLY!');
  console.log('================================================================');
}
